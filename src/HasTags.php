...
trait HasTags
{
    ...
    {
        return config('wncms-tags.taggable.table_name', 'taggables');
    }

    public function getPivotModelClassName(): string
    {
        return config('wncms-tags.taggable.class_name', MorphPivot::class);
    }
    ...
    {
        return $this
            ->morphToMany(wncms()->getModelClass('tag'), $this->getTaggableMorphName(), $this->getTaggableTableName())
